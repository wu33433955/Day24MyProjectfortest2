 ...
 */
public class CFragment extends Fragment implements AbsListView.OnScrollListener, AdapterView.OnItemClickListener, JsonDownloadUtil.onDownloadJsonListener {
    private int page=1;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(position>0){
            ...
            Intent intent = new Intent(CFragment.this.getActivity(),Info.class);
            //传递当前详情界面需要拼凑的URL
